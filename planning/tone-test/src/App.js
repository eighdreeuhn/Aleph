    ...
    <div className='App'>
      ...
      <section>
        <form onSubmit={handlePhraseSubmit}>
          <label><h3>Play many notes<input type='text' onChange={handlePhraseChange} value={phrase} placeholder='Un-ask your question as a phrase'></input></h3></label>
            
        </form>
        <form onSubmit={handleLetterSubmit}>
          <label><h3>Play a single chord<input type='text' onChange={handleLetterChange} value={letter} placeholder='Un-ask your question with a single letter'/></h3></label>
